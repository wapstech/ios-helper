        ...
        id <SDWebImageOperation> operation = [SDWebImageManager.sharedManager downloadImageWithURL:url options:options progress:progressBlock completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
            ...
            dispatch_main_sync_safe(^{
                ...
                if (image) {
                    ...
                    NSLog(@"%ld",wself.tag);
                    if (wself.tag==10005) {
                        [[NSNotificationCenter defaultCenter] postNotificationName:@"xianzaitupian" object:nil];
...
//                        
//                        [self data:data tagzhi:wself.tag];
//                        
//                        NSLog(@"wself.image  %ld",wself.tag);
//
//                    }
...
-(void)data:(NSData *)str tagzhi:(NSInteger )but{
    
    NSString* pictureDataString = [str base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] init];
    //
    [dic setObject:[NSNumber numberWithInteger:but] forKey:@"sid"];
    [dic setObject:pictureDataString forKey:@"sdata"];
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"jiahuancunhuanfu" object:nil userInfo:dic];
